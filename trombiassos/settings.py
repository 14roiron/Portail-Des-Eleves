...
ADMINS = (
     ('Edouard Leurent', '11leuren@ensmp.fr'),('Valentin Anjou', '13anjou@ensmp.fr')
)
...
DATABASES = {
    'default': {
        ...
        'NAME': '52227_portail_2',                      # Or path to database file if using sqlite3.
        'USER': '52227',                      # Not used with sqlite3.
        'PASSWORD': 'stebarbe',                  # Not used with sqlite3.
...
SECRET_KEY_UPDATE = 'kbjb=1&@fe2z@fsv!n7=vera&5jdnfv(ln_g0e(&=afvf1ezf8'
